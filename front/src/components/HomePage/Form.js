            ...
            <form>
                ...
                <div className="p-field p-grid p-jc-end">
                    ...
                    <div className="p-sm-12 p-md-7 p-xl-5">
                        <Dropdown value={x_val} options={options} onChange={(e) => {setX(e.value)}} placeholder="Select X"/>
                    </div>
                </div>
                <div className="p-field p-grid p-jc-end">
                ...
                <div className="p-field p-grid p-jc-end">
                    ...
                    <div className="p-sm-12 p-md-7 p-xl-5">
                        <Dropdown value={r_val} options={options} onChange={(e) => {setR(e.value)}} placeholder="Select R"/>
                    </div>
                </div>
                <div className="p-field p-grid p-jc-end">
